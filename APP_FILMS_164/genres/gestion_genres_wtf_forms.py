...
class FormWTFAjouterGenres(FlaskForm):
    ...
    nom_genre_wtf = StringField("Ajouter numéro de salle ", validators=[Length(min=2, max=20, message="min 2 max 20"),
    ...
    Num_bureau_wtf = StringField("Ajouter numéro de bureau ", validators=[Length(min=2, max=20, message="min 2 max 20"),
                                                                   Regexp(nom_genre_regexp,
                                                                          message="Pas de chiffres, de caractères "
                                                                                  "spéciaux, "
                                                                                  "d'espace à double, de double "
