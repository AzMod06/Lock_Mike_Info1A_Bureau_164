...
from APP_BUREAU_164.erreurs.msg_erreurs import *
from APP_BUREAU_164.essais_wtf_forms.wtf_forms_demo_select import DemoFormSelectWTF
    ...
    try:
        ...
        if request.method == "GET":
            with DBconnection() as mc_afficher:
                strsql_genres_afficher = """SELECT id_bureau, Salle_bureau FROM t_bureau ORDER BY id_bureau ASC"""
            ...
            for i in data_genres:
                genre_val_list_dropdown.append(i['Salle_bureau'])
