...
from APP_BUREAU_164 import app
from APP_BUREAU_164.database.database_tools import DBconnection
from APP_BUREAU_164.erreurs.exceptions import *
from APP_BUREAU_164.genres.gestion_genres_wtf_forms import FormWTFAjouterGenres
from APP_BUREAU_164.genres.gestion_genres_wtf_forms import FormWTFDeleteGenre
from APP_BUREAU_164.genres.gestion_genres_wtf_forms import FormWTFUpdateGenre
        ...
        try:
            with DBconnection() as mc_afficher:
                if order_by == "ASC" and id_genre_sel == 0:
                    strsql_genres_afficher = """SELECT * from t_bureau  WHERE id_bureau ORDER BY Salle_bureau ASC"""
                    ...
                    strsql_genres_afficher = """SELECT * from t_bureau WHERE id_bureau """

                    mc_afficher.execute(strsql_genres_afficher, valeur_id_genre_selected_dictionnaire)
                else:
                    strsql_genres_afficher = """SELECT * from t_bureau"""
    ...
    if request.method == "POST":
        try:
            if form.validate_on_submit():
                ...
                strsql_insert_genre = """INSERT INTO t_bureau (id_bureau, Salle_bureau) VALUES 
...
def genre_update_wtf():
    ...
    try:
        ...
        if form_update.validate_on_submit():
            ...
            str_sql_update_intitulegenre = """UPDATE t_bureau SET Salle_bureau = %(value_name_genre)s, 
            Num_bureau = %(value_date_genre_essai)s WHERE id_bureau = %(value_id_genre)s """
            with DBconnection() as mconn_bd:
            ...
            str_sql_id_genre = "SELECT id_bureau, Salle_bureau, Num_bureau FROM t_bureau        " \
                               "WHERE id_bureau = %(value_id_genre)s"
            ...
            print("data_nom_genre ", data_nom_genre, " type ", type(data_nom_genre), " genre ",
                  data_nom_genre["Salle_bureau"])

            # Afficher la valeur sélectionnée dans les champs du formulaire "genre_update_wtf.html"
            form_update.nom_genre_update_wtf.data = data_nom_genre["Salle_bureau"]
            form_update.date_genre_wtf_essai.data = data_nom_genre["Num_bureau"]
    ...
    try:
        ...
        if request.method == "POST" and form_delete.validate_on_submit():
            ...
            if form_delete.submit_btn_conf_del.data:
                ...
                flash(f"Effacer le bureau de façon définitive de la BD !!!", "danger")
        ...
        if request.method == "GET":
            ...
            with DBconnection() as mydb_conn:
                ...
                # Opération sur la BD pour récupérer "id_genre" et "intitule_genre" de la "t_genre"
                str_sql_id_genre = "SELECT id_bureau, Salle_bureau FROM t_bureau WHERE id_bureau = %(value_id_genre)s"
            ...
            form_delete.nom_genre_delete_wtf.data = data_nom_genre["Salle_bureau"]
